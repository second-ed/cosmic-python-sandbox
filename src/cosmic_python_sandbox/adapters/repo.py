...
from cosmic_python_sandbox.adapters.fs_wrappers._fs_protocol import (
    FakeFileSystem,
    FileSystemProtocol,
)
from cosmic_python_sandbox.adapters.io_wrappers._io_protocol import FakeIOWrapper, IOWrapperProtocol
